...
{
    class OverState : AbstractState
    {
        private String part1;
        private String part2;
        private float presicion;

        public OverState(String p1, String p2, float presicion, string nameState)
            : base(nameState)
        {
            this.part1 = p1;
            this.part2 = p2;
        ...
        // TRUE: Si parte 1 esta sobre parte 2 en altura
