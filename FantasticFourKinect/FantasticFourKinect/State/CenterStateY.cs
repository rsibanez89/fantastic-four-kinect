...
{
    class CenterStateY : AbstractState
    {
        private String part1;
        private String part2;
        private float presicion;

        public CenterStateY(String p1, String p2, float presicion, string nameState)
            : base(nameState)
        {
            this.part1 = p1;
            this.part2 = p2;
        ...
        // TRUE: Si parte 1 esta en el mismo valor de y que la parte 2
        ...
        public override bool cumple(HumanSkeleton hS)
        {
            ...
            return (Math.Abs(p1.Y - p2.Y) < presicion);
        }
